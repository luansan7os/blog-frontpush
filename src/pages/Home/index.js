...
const Home = () => {
  let post = {
    ...
    resume:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ornare urna pharetra ut ac, pellentesque. Ultricies habitasse pretium purus viverra.",
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ornare urna pharetra ut ac, pellentesque. Ultricies habitasse pretium purus viverra.",
    duration: "10min",
  };
  ...
  */
  useEffect(() => {
    ...
    api.get("/posts?star=5&_limit=3").then((response) => {
      ...
      <section className="container">
        <div className="row">
          <div className="grid-5 pt-5 pb-3 bb-black">
            ...
            <p className="my-1">
              A seguir serão listados os 3 posts com 5 estrelas nas votações.
              Leia e vote também.
            </p>
          </div>
